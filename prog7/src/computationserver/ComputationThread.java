...
public class ComputationThread implements Runnable {
    ...
    public ComputationThread(DatagramSocket socket, DatagramPacket packet) {
        this.socket = socket;
        this.packet = packet;
    }
    ...
    public void run() {
        ...
        try (DataOutputStream toClient = new DataOutputStream(new ByteArrayOutputStream(BUF_SIZE))) {
